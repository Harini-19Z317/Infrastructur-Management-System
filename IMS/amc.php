...
<div class="container">
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="bcp"   name="bcp" pattern="[0-9]+" oninvalid="alert('Enter the Basic cost price');" class="container" value="12000" required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="quantity" name="quantity" pattern="[0-9]+" oninvalid="alert('Enter the Quantity');" class="container" value="12000" required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
         <input type="text" id="value" name="amccost" value="12000" class="container" pattern="[0-9]+" oninvalid="alert('Enter a valid value');"required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="warranty" name="warranty" pattern="[0-9]+" class="container" value="5" oninvalid="alert('Enter the warranty period');" required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="mainamt" name="mainamt" pattern="[0-9]+" class="container" value="2000" oninvalid="alert('Enter the amount');" required>
      </div>
    </div>
