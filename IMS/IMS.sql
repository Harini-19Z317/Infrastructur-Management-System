...
(3, 'Tiruppur', 'talukk', 'villagee', 56, 'area', 25),
...
(15, 'Coimbatore', 'tirupurnorth', 'tiruppur', 12, ' Good ', 23);
...
(101, 'Executive table', 2, ''),
(102, 'Revolving chair', 2, ''),
...
(5009, 'server', 'hp', '123', '20', 'ecourt', 'tirupur', '1200', '2001', '2022-05-11', '2024-05-16'),
(5012, 'laptop', 'dell', '123', '12', 'sub court building -udt', 'ecourt', '1200', '1200', '2022-05-25', '2022-06-15'),
(5013, 'server', 'hp', '1234', '20', 'sub court building -udt', 'ecourt', '12000', '2001', '2022-05-11', '2022-05-27'),
...
--
ALTER TABLE `furniture_details`
  MODIFY `furniture_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1035;

--
-- AUTO_INCREMENT for table `itstocks`
--
ALTER TABLE `itstocks`
  MODIFY `IT_Stocks_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5015;
