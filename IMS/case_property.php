  ...
  <div class="container">
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="case_no" class="form-control" value="2001" pattern="[0-9]+" oninvalid="alert('Enter a valid case no.');" maxlength="50" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="charge_sheet_no" class="form-control" value="10" maxlength="50" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="name_of_the_station" class="form-control" value="station" maxlength="50" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="serial_no" class="form-control" value="9" maxlength="30" required="">
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="valuable_property" class="form-control" value="property1" maxlength="90" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="other_properties" class="form-control" value="properties" maxlength="50" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="initials_of_judge1" class="form-control" value="initial1" maxlength="50" required="">
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="particulars" class="form-control" value="particulars" maxlength="50" required="">
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="section_of_law" class="form-control" value="section" maxlength="50" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="signature_of_party" class="form-control" value="sign" maxlength="50" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="initials_of_judge2" class="form-control" value="initial" maxlength="50" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="initials_of_judge3" class="form-control" value="initial" maxlength="50" required="">
        </div>
      </div>
      <div class="row">
        <div class="col-25">
        ...
        <div class="col-75">
          <input type="text" name="remarks" class="form-control" value="remarks" maxlength="50">
        </div>
      </div>
